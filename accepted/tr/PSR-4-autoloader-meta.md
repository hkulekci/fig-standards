...
Amaç, dosya sistemini namespace'ler ile eşleştirmek ve diğer SPL 
önyükleyicileri ile birlikte çalışabilecek, bir PHP otomatik yükleyici 
(autoloder) sistemi için kurallar belirlemektir. Bu PSR-0'a bir ekleme 
olacaktır, değiştirme değil.
