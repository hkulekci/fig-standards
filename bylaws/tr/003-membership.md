...
PHP Framework Interoperability Group (PHP-FIG) üyeliği üye projelerin 
oluşumudur. Bu iç tüzük kuralları ve üyelik haklarını tanımlamaktadır.

Tanım
-----------

<dl>
    <dt><strong>Üye Projeler</strong></dt>
    <dd>
        Bu iç tüzükte tanımlanan üye başvuru prosedürleri kapsamında, 
        PHP-FIG posta listesine bir uygulama gönderdikten sonra 
        PHP-FIG'e başvuruyu hakkı olan herhangi bir PHP projesi.
    </dd>
    <dt><strong>Oylama Temsilcisi</strong></dt>
    <dd>
        Bir üye projesi adına oy atma hakkı olan herhangi bir birey.
    </dd>
</dl>
...
PHP-FIG'deki şu anki Üye Projeleri aşağıdaki bağlantıda listelenmektedir:
http://www.php-fig.org/

Bu liste ayrıca her bir Üye Projesi için Oylama Temsilcisilerinin isimlerini 
göstermelidir. Bu liste Üye Projelerinde veya Oylama Temsilcilerindeki 
